...
var header = 
  ...
  '\\usepackage[Latin, Cyrillics, Greek, CJK, Arabics, Hebrew, Armenian, Bengali,\n' +
  '  Cherokee, Georgian, Greek, Gujarati, Devanagari, Kannada, Khmer, Korean, Lao,\n' +
  '  Gurmukhi, Tamil, Thai, Tibetan, Ethiopic, Yi]{ucharclasses}\n' +
  ...
  '\\setTransitionTo{Hebrew}{\\fontspec[Scale=1.2]{New Peninim MT}}\n' +
  '\\setTransitionTo{Armenian}{\\fontspec{Mshtakan}}\n' +
  '\\setTransitionTo{Bengali}{\\fontspec{Bangla MN}}\n' +
  '\\setTransitionTo{Cherokee}{\\fontspec{Plantagenet Cherokee}}\n' +
  '\\setTransitionTo{Georgian}{\\fontspec{Helvetica}}\n' +
  '\\setTransitionsFor{Greek}{\\fontspec{Times}}{}\n' +
  '\\setTransitionTo{Gujarati}{\\fontspec{Gujarati MT}}\n' +
  '\\setTransitionTo{Devanagari}{\\fontspec{Devanagari MT}}\n' +
  '\\setTransitionTo{Kannada}{\\fontspec{Kannada MN}}\n' +
  '\\setTransitionTo{Khmer}{\\fontspec{Khmer MN}}\n' +
  '\\setTransitionsForKorean{\\fontspec{AppleMyungjo}}{}\n' +
  '\\setTransitionTo{Lao}{\\fontspec{Lao MN}}\n' +
  '\\setTransitionTo{Gurmukhi}{\\fontspec{Gurmukhi MT}}\n' +
  '\\setTransitionTo{Tamil}{\\fontspec{InaiMathi}}\n' +
  '\\setTransitionTo{Thai}{\\fontspec{Thonburi}}\n' +
  '\\setTransitionTo{Tibetan}{\\fontspec{Kokonor}}\n' +
  '\\setTransitionTo{Ethiopic}{\\fontspec{Kefa}}\n' +
  '\\setTransitionsFor{Yi}{\\fontspec{STSong}}{}\n' +
  '\n' +
  '% for RTL scripts\n' +
  '\\usepackage{bidi}\n' +
  '\n' +
